document.addEventListener("DOMContentLoaded", function () {
  ...
  function iniciarAnimacao() {
    escreverTexto("saudacao", "Sejam bem vindos...", 150); // Escreve "Olá, meu nome é"

    // Espera o texto anterior terminar antes de começar a escrever o próximo
    setTimeout(() => {
      escreverTexto("meuNome", "A Guilda Sangue Valente", 150); // Escreve "Danillo Guimarães"
    }, 3000); // Espera 3 segundos antes de começar

    setTimeout(() => {
      escreverTexto("profissao", "Servidor DaVinci", 150); // Escreve "Desenvolvedor Front End"
